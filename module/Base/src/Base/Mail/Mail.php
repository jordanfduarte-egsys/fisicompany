...
{    
    ...
    public function setSebject($subject)
    {
    ...
    {
        $model = new ViewModel();
        $model->setTemplate("/mailer/mailer/{$page}.phtml");
    ...
    public function prepare()
    {
       ...
       // \Zend\Debug\Debug::dump(get_class_methods($this->transport)); exit;
    ...
    {
       echo $this->transport->send($this->message);
       die("OKDOKSKDSK1");
    }
}